# -*- coding: utf-8 -*-
"""
Copyright of this this package belongs to Benyamin Motevalli. 
The package uses the CSIRO Open Source Software Licence (Based on MIT/BSD Open Source Licence).
