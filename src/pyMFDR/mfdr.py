...
def mf(X, k, alg = 'PCA', display = True, verbose = 0):
    ...
    elif (alg == ALGS[3] or alg == 'GRP' or alg == 'SRP'):
...
def measure_time(X, alg = 'PCA', display = True, r = list(range(1, 51)), repeat = 10):
    '''
